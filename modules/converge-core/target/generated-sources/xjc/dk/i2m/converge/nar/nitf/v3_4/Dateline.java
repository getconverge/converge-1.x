 ...
 *         &lt;element ref="{http://iptc.org/std/NITF/2006-10-18/}story.date"/>
 *       &lt;/choice>
...
@XmlRootElement(name = "dateline")
public class Dateline {

    @XmlElementRefs({
        @XmlElementRef(name = "location", namespace = "http://iptc.org/std/NITF/2006-10-18/", type = Location.class),
        @XmlElementRef(name = "story.date", namespace = "http://iptc.org/std/NITF/2006-10-18/", type = StoryDate.class)
    })
    @XmlMixed
