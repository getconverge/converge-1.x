...
public class CropImageTest {
    ...
    @Test
    public void cropImage_highResolutionImageCropToRectangel_outputCroppedImage() {
        ...
        try {
            ...
            ImageIO.write(cropped, "jpg", new File("target/cropImage_highResolutionImageCropToRectangel_outputCroppedImage.jpg"));
