...
public class NewsML {
    ...
    public static class NewsEnvelope {
        ...
        public static class SentFrom {
            ...
            protected List<dk.i2m.converge.plugins.decoders.newsml12.binding.NewsComponentType.AdministrativeMetadata.Contributor.Party> party;
            @XmlAttribute(name = "Duid")
            @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
            @XmlID
            @XmlSchemaType(name = "ID")
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link dk.i2m.converge.plugins.decoders.newsml12.binding.NewsComponentType.AdministrativeMetadata.Contributor.Party }
             * 
             * 
             */
            public List<dk.i2m.converge.plugins.decoders.newsml12.binding.NewsComponentType.AdministrativeMetadata.Contributor.Party> getParty() {
                if (party == null) {
                    party = new ArrayList<dk.i2m.converge.plugins.decoders.newsml12.binding.NewsComponentType.AdministrativeMetadata.Contributor.Party>();
                }
                return this.party;
            }
