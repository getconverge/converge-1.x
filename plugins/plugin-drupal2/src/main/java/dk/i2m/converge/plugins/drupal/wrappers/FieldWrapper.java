...
package dk.i2m.converge.plugins.drupal.wrappers;

/**
 * Drupal basic field wrapper.
 */
public class FieldWrapper extends BasicWrapper {

    @Override
    public String format(String field, int index) {
        return String.format("%s[%s][%d][value]", field, getLanguage(), index);
    }
}
