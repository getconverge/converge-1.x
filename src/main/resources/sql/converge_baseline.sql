...
# Dump of table catalogue_hook_property
# ------------------------------------------------------------
...
# Dump of table catalogue_rendition
# ------------------------------------------------------------
...
# Dump of table content_language
# ------------------------------------------------------------
...
# Dump of table department_membership
# ------------------------------------------------------------
...
# Dump of table edition_template
# ------------------------------------------------------------
...
# Dump of table edition_template_section
# ------------------------------------------------------------
...
# Dump of table financial_market
# ------------------------------------------------------------
...
# Dump of table job_queue_parameter
# ------------------------------------------------------------

DROP TABLE IF EXISTS `job_queue_parameter`;
...
# Dump of table media_item_concept
# ------------------------------------------------------------
...
# Dump of table media_item_rendition
# ------------------------------------------------------------
...
# Dump of table news_item_edition_state
# ------------------------------------------------------------

DROP TABLE IF EXISTS `news_item_edition_state`;
...
# Dump of table outlet_edition_action_property
# ------------------------------------------------------------
...
# Dump of table outlet_subscriber
# ------------------------------------------------------------

DROP TABLE IF EXISTS `outlet_subscriber`;
...
# Dump of table photo_entry_type
# ------------------------------------------------------------
...
# Dump of table user_account_membership
# ------------------------------------------------------------
...
# Dump of table user_account_newswire_services
# ------------------------------------------------------------
...
# Dump of table user_role_privilege
# ------------------------------------------------------------
...
# Dump of table weather_forecast
# ------------------------------------------------------------
...
# Dump of table weather_location
# ------------------------------------------------------------
...
# Dump of table weather_situation
# ------------------------------------------------------------
...
CREATE TABLE `workflow_state` (
  ...
  `style_fg` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
...
# Dump of table workflow_state_visible
# ------------------------------------------------------------
...
# Dump of table workflow_step_action
# ------------------------------------------------------------
...
# Dump of table workflow_step_action_property
# ------------------------------------------------------------
...
# Dump of table workflow_step_user_role
# ------------------------------------------------------------
...
# Dump of table workflow_step_validation
# ------------------------------------------------------------
...
# Dump of table workflow_step_validator
# ------------------------------------------------------------
...
# Dump of table workflow_step_validator_property
# ------------------------------------------------------------
...
VALUES
	('cn=converge,[PUT PATH TO GROUPS]','LDAP_GROUP_USERS'),
	('cn=converge-administrator,[PUT PATH TO GROUPS]','LDAP_GROUP_ADMINISTRATORS'),
	('ldap://[PUT URL TO LDAP SERVICE]','LDAP_PROVIDER_URL'),
	('[PUT YOUR BASE DN]','LDAP_BASE'),
	('[PUT LDAP ADMINISTRATOR DN]','LDAP_SECURITY_PRINCIPAL'),
	('[PUT LDAP ADMINISTRATOR PASSWORD]','LDAP_SECURITY_CREDENTIALS'),
	('[PUT WORKING DIRECTORY FOR CONVERGE]','WORKING_DIRECTORY'),
	('INVALID','INVALID'),
	('Welcome.xhtml','LOGOUT_REDIRECT'),
	('dk.i2m.converge.i18n.Messages','MESSAGE_BUNDLE'),
	('dk.i2m.converge.server.ws.messages','XML_MESSAGE_PACKAGE'),
	('EN','LANGUAGE'),
	('US','COUNTRY'),
	('CET','TIME_ZONE'),
	('30','NEWSWIRE_INTERVAL'),
	('48','NEWSWIRE_LONGEVITY'),
	('cn','LDAP_GROUP_MAPPING_NAME'),
	('uniquemember','LDAP_GROUP_MAPPING_MEMBEROF'),
	('uid','LDAP_USER_MAPPING_USERNAME'),
	('givenName','LDAP_USER_MAPPING_FIRST_NAME'),
	('sn','LDAP_USER_MAPPING_LAST_NAME'),
	('cn','LDAP_USER_MAPPING_COMMON_NAME'),
	('title','LDAP_USER_MAPPING_JOB_TITLE'),
	('mobile','LDAP_USER_MAPPING_MOBILE'),
	('telephoneNumber','LDAP_USER_MAPPING_PHONE'),
	('mail','LDAP_USER_MAPPING_EMAIL'),
	('preferredLanguage','LDAP_USER_MAPPING_LANGUAGE'),
	('employeeType','LDAP_USER_MAPPING_EMPLOYEE_TYPE'),
	('businessCategory','LDAP_USER_MAPPING_FEE_TYPE'),
	('jpegPhoto','LDAP_USER_MAPPING_JPEG_PHOTO'),
	('company','LDAP_USER_MAPPING_ORGANISATION'),
	('Story','LDAP_FEE_TYPE_MAPPING_STORY'),
	('Word','LDAP_FEE_TYPE_MAPPING_WORD'),
	('Fixed','LDAP_FEE_TYPE_MAPPING_FIXED'),
	('Permanent','LDAP_EMPLOYMENT_TYPE_MAPPING_PERMANENT'),
	('Freelance','LDAP_EMPLOYMENT_TYPE_MAPPING_FREELANCE'),
	('com.sun.jndi.ldap.LdapCtxFactory','LDAP_CONNECTION_FACTORY'),
	('simple','LDAP_SECURITY_AUTHENTICATION'),
	('1','EDITION_INTERVAL'),
	('60','CATALOGUE_WATCH_INTERVAL'),
	('1','SEARCH_ENGINE_INDEXING_INTERVAL'),
	('http://localhost:8080/apache-solr-1.4.1/newsitems','SEARCH_ENGINE_URL'),
	('http://localhost:8080/apache-solr-1.4.1/newswires','SEARCH_ENGINE_NEWSWIRE_URL'),
	('30000','SEARCH_ENGINE_SOCKET_TIMEOUT'),
	('30000','SEARCH_ENGINE_CONNECTION_TIMEOUT'),
	('false','SEARCH_ENGINE_FOLLOW_REDIRECTS'),
	('100','SEARCH_ENGINE_MAX_TOTAL_CONNECTIONS_PER_HOST'),
	('100','SEARCH_ENGINE_MAX_TOTAL_CONNECTIONS'),
	('1','SEARCH_ENGINE_MAX_RETRIES'),
	('5000','LDAP_CONNECT_TIMEOUT'),
	('5000','LDAP_READ_TIMEOUT'),
	('30','NEWSWIRE_BASKET_INTERVAL'),
	('noreply@getconverge.com','NEWSWIRE_BASKET_MAIL'),
	('http://localhost:8080/converge/','CONVERGE_HOME_URL'),
	('true','SEARCH_ENGINE_ALLOW_COMPRESSION');
